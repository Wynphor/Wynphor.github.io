...
function changeColor() {
    ...
    //     // 白天模式恢复默认
    //     if (document.getElementsByClassName("site-name")[0])
    //         document.getElementsByClassName("site-name")[0].style.textShadow = "#1e1e1ee0 1px 1px 1px";
    //     if (document.getElementById("site-title"))
    ...
    //     try {
    //         document.getElementsByClassName("author-info__name")[0].style.textShadow = "#1e1e1ee0 1px 1px 1px";
    //         document.getElementsByClassName("author-info__description")[0].style.textShadow = "#1e1e1ee0 1px 1px 1px";
    //     } catch {
